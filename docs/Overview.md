...
Starting the server with validateFlag: false in the .mf.config.json file should allow "bad" method override values either via POSTs to /api/v1/state or via the CLI (--result or --upload)
