    ...
    methods: [
      ...
      },
      {
        ...
        tags: [
          {
            name: 'capabilities',
            'x-uses': ['xrn:firebolt:capability:advertising:identifier'],
          },
        ],
    ...
    methods: [
      ...
      },
      {
        ...
        tags: [
          {
            name: 'capabilities',
            'x-uses': ['xrn:firebolt:capability:metrics:distributor'],
          },
        ],
      ...
      schemas: {
        ...
        StandbyEvent: {
          ...
          properties: {
            reason: {
              type: 'string',
              enum: ['inactivity', 'rcu', 'frontPanel', 'hdmiCec', 'dial', 'farFieldVoice', 'ux'],
            },
          },
        },
        ResumeEvent: {
          ...
          properties: {
            reason: {
              type: 'string',
              enum: ['system', 'rcu', 'frontPanel', 'hdmiCec', 'dial', 'motion', 'farFieldVoice'],
            },
          },
        },
        SuspendEvent: {
        ...
        InactivityCancelledEvent: {
          ...
          properties: {
            reason: {
              type: 'string',
              enum: ['rcu', 'frontPanel', 'farFieldVoice', 'dial', 'hdmiCec', 'motion'],
            },
          },
        },
        ContentPolicy: {
          title: 'ContentPolicy',
          type: 'object',
          required: ['enableRecommendations', 'shareWatchHistory', 'rememberWatchedPrograms'],
          properties: {
