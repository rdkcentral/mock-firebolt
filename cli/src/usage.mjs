...
const lines = [
  ...
  { cmdInfo: "--downloadOverrides git@github.comcast.com:lightning-automation/firebolt-cert-test-data.git",               comment: "Specifies the url of a github repository to clone"},
